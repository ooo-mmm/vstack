...
//
// Retry timing prefers authoritative structured quota data. Assistant prose is
// used to classify/trigger recovery, not as the primary schedule source: live
// Claude usage endpoint snapshots win first, SDK rate_limit_event reset/retry
// fields win next, and prose reset parsing remains only as a degraded fallback
// before the plain backoff ladder.
//
