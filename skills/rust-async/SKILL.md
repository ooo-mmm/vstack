---
name: rust-async
description: "Async Rust patterns: Future/Poll contract, Pin/Unpin, tokio tasks, select!/join!, cancellation safety, structured concurrency, async traits, streams. Load for async fn, .await, tokio::spawn, futures, channels."
license: MIT
user-invocable: true
metadata:
  author: vanillagreen
