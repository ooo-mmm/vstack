---
name: rust-cargo
description: "Cargo workspace setup, dependency management, feature flags, build performance (linker, caching, cranelift), release profiles, and CI pipelines. Load when configuring Cargo.toml, optimizing compile times, or setting up cargo-deny/nextest/machete."
license: MIT
user-invocable: true
metadata:
  author: vanillagreen
